            ...
            <>
              <div className="login__box">
                <div className="box__inner">
                  ...
                  <div className="login__emailDisplay">
                    <span>{email}</span>
                    <span className="login__goback" onClick={goback}>
                      Change
                    </span>
                  </div>
                  <div className="login__formContainer"></div>
                  <form onSubmit={login}>
                    ...
                    <div className="login__boxBottom">
                      ...
                      <div className="login__detail">
                        <label className="subtotal__label" htmlFor="checkbox">
